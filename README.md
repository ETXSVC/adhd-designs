...
Optionally, once a blueprint is picked, click "✨ Generate title,
description & tags with AI" (on the variants & price step) to have Claude
draft e-commerce listing copy from the artwork — requires
